...
let oilEl = document.getElementById('oil');
let sportEl = document.getElementById('sport');
let phylosophyEl = document.getElementById('phylosophy');
let historyEl = document.getElementById('history');
let mathEl = document.getElementById('math');
let geographyEl = document.getElementById('geography');
let medicineEl = document.getElementById('medicine');
let journalismEl = document.getElementById('journalism');
let literatureEl = document.getElementById('literature');
...
// порпобовать объединить через this
